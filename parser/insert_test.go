...
func TestInsertOnConflictDoNothing(t *testing.T) {
	...
	if stmt.OnConflictClause.Action != ONCONFLICT_NOTHING {
		t.Errorf("expected ONCONFLICT_NOTHING (%d), got %d", ONCONFLICT_NOTHING, stmt.OnConflictClause.Action)
	}
...
func TestInsertOnConflictDoUpdate(t *testing.T) {
	...
	if stmt.OnConflictClause.Action != ONCONFLICT_UPDATE {
		t.Errorf("expected ONCONFLICT_UPDATE (%d), got %d", ONCONFLICT_UPDATE, stmt.OnConflictClause.Action)
	}
...
func TestInsertOnConflictWithInfer(t *testing.T) {
	...
	if stmt.OnConflictClause.Action != ONCONFLICT_NOTHING {
		t.Errorf("expected ONCONFLICT_NOTHING, got %d", stmt.OnConflictClause.Action)
	}
...
func TestInsertOnConflictDoUpdateWithWhere(t *testing.T) {
	...
	if stmt.OnConflictClause.Action != ONCONFLICT_UPDATE {
		t.Errorf("expected ONCONFLICT_UPDATE, got %d", stmt.OnConflictClause.Action)
	}
