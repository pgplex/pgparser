...
func TestCreateViewBasic(t *testing.T) {
	...
	if stmt.WithCheckOption != VIEW_CHECK_OPTION_NONE {
...
func TestCreateViewWithCheckOption(t *testing.T) {
	...
	if stmt.WithCheckOption != VIEW_CHECK_OPTION_LOCAL {
		t.Errorf("expected WithCheckOption LOCAL (%d), got %d", VIEW_CHECK_OPTION_LOCAL, stmt.WithCheckOption)
	}
	if stmt.Query == nil {
		t.Fatal("expected Query to be set")
	}
...
func TestCreateViewWithCascadedCheckOption(t *testing.T) {
	...
	if stmt.WithCheckOption != VIEW_CHECK_OPTION_CASCADED {
		t.Errorf("expected WithCheckOption CASCADED (%d), got %d", VIEW_CHECK_OPTION_CASCADED, stmt.WithCheckOption)
	}
	if stmt.Query == nil {
		t.Fatal("expected Query to be set")
	}
